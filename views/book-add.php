                ...
                <form action="index.php?action=book-add" method="POST" enctype="multipart/form-data">
                    <label for="isbn">Numer isbn <br>
                        ...
                        <div class="author-names">
                            ...
                            ?>
                                <span class="author-name-block">
                                <label class="author-name" for=<?php echo "aut-" . $author["id_autor"] ?> value=<?php $author["id_autor"] ?>><?php
                                                                                                                                                echo $author['imie'] . " " . $author["nazwisko"];
                                                                                                                                                ?></label>
                                <input type="checkbox" name="author[]" id=<?php echo "aut-" . $author["id_autor"] ?> value=<?php echo $author["id_autor"] ?>>
                                </span>
                            <?php }
                            ?>
                        </div>
