...
<form action="index.php?action=add-genre" method = "POST" multipart/from-data></form>
       <form action="index.php?action=add-genre" method="POST" enctype="multipart/form-data">
